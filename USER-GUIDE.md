...
| **Holdings** | Brokerage CSV import, gain/loss, concentration (private to you) |
...
Share counts and cost basis are **encrypted at rest** for your account.

**Privacy:** Your holdings are visible only to you. Other people on this server
cannot see them, and neither can the admin. There is no admin view of friends’
portfolios.
...
- Your holdings are yours alone: not visible to other users, and not to the admin.
- Your watchlist, alerts, and settings are also private to your account.
